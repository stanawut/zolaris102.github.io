		...
		<div class="container">
			<header class="d-flex justify-content-center py-3">
				<ul class="nav nav-pills">
					<li class="nav-item"><a href="/Earth/xfilx_xxxxx_00200_xxxxx/{form_id}/{store_id}/{file_id}" class="nav-link">Edit</a></li>
					<li class="nav-item"><a href="/Venus/xdocx_xxxxx_00600_xxxxx" 									class="nav-link">x</a></li>
				</ul>
			</header>
		</div>
		<!--KXditorMenuBar data={{menu:xmenubarRow1}}/-->
		<!--KXditorMenuBar data={{menu:xmenubarRow2}}/-->
		<!--KXditorMenuBar data={{menu:xmenubarRow3}}/-->
