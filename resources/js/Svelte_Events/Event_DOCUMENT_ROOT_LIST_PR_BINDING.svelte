...
{
	console.log('+++++++++++++++ handle_document_root_event_dispatcher < Event_DOCUMENT_LIST_PR_BINDING');
	let xTag = '';
...
onMount(()=>
{
	console.log('=========================== Event_DOCUMENT_LIST_PR_BINDING ===========================');
	const document_root = document.querySelector('#LIST_PR');
