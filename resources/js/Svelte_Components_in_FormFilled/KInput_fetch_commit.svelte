	...
	const handleClick = (e)=>{ 
		...
		switch (e.target.id)
		{
			case 'nditor_main_bind':
															...
															{
																alert(data.tid);
																console.log('nditor_main_bind id:'+data.tid,'sourcedata:'+sourcedata.active_tt_id);
																oXmlAny.commit_bind_doc(sourcedata.active_tt_id,data.atext);
															}
															else
															{	
															...
															akvInputParams = 
																										{ 
																											doc_type								: data.atext.type,//'cat' or 'lib',
