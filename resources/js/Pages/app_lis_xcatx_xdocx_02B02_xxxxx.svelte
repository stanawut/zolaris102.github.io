<script>
	...
	function _inject_nmenu(p_hemCat,p_iactiveCatTid)
	{
		...
		let atext 						= {type:'cat',tagname:'PR_01',th:'',en:'',ch:'',xx:p_iactiveCatTid,textcontent:''};
	...
	{
		console.log('p_iactiveCatTid:',p_iactiveCatTid);
		console.log(oXmlInstance._xmldoc);
		...
		<div class="container">
			<header class="d-flex justify-content-center py-3">
				<ul class="nav nav-pills">
					...
					<li class="nav-item"><a href="/Venus/xcatx_xdocx_02B02_xxxxx/{file_id}" class="nav-link active" aria-current="page">☰ Doc</a></li>
