...
<main>
	...
	<Layout>
		<div class="container">
			<header class="d-flex justify-content-center py-3" style="padding-bottom:0.1rem !important;">
				<ul class="nav nav-pills">
					<li class="nav-item"><a href="/Venus/xfrmx_xxxxx_00200_xxxxx/{file_id}" class="nav-link" aria-current="page">Edit</a></li>
					<li class="nav-item"><a href="/Venus/xfrmx_xlibx_02B02_xxxxx/{file_id}" class="nav-link" aria-current="page">☰ Lib</a></li>
					<li class="nav-item"><button id="xditor_main_bkx" class="nav-link active" on:click={e=>handleListBook(e)} 	on:keypress={handleListBook}>☰ Store</button></li>
					<li class="nav-item"><a href="/gridboard" class="nav-link">&#10006;</a></li>
				</ul>
			</header>
			<header class="d-flex justify-content-center py-3" style="padding-top:0px !important;">
				<ul class="nav nav-pills">
					<li class="nav-item"><a href="/Earth/xstrx_xfrmx_00100_xxxxx/{file_id}" class="nav-link" aria-current="page">Create</a></li>
					<li class="nav-item"><a href="/Venus/xfrmx_xstrx_00600_xxxxx/{file_id}" class="nav-link" aria-current="page">☰ List</a></li>
				</ul>
			</header>
		</div>
