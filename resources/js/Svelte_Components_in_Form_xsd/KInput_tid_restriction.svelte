<script>
	/* ---------------------------------------------------------------------------------------------- */
	import { FieldsCollection as Fields } from '../Svelte_AllConstants/ConstantSet4_form.js';
...
<div class="bd-example">
			...
			<form>
				...
				<div class="row">
				{#each Fields.input_text.input_checktext_restriction_base_xs_all as field,i}

					<div class="col-4">
								{field.placeholder}
					</div>
					<div class="col-8">
							<input type="text" class="form-control" id={field.id}  value={data.xx[field.id]}/>
					</div>
					<div class="w-100"></div>
