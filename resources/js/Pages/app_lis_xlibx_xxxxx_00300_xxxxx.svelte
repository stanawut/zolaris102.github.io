<script>
	...
	const handleListCat = async (e)=>{ 
															...
															let txurl	= '/Venus/xlibx_xxxxx_00600_xxxxx/list';
		...
		<div class="container">
			<header class="d-flex justify-content-center py-3">
				<ul class="nav nav-pills">
					<li class="nav-item"><a href="/Venus/xlibx_xxxxx_00200_xxxxx/{file_id}" class="nav-link active" aria-current="page">Edit</a></li>
					<li class="nav-item"><button id="xditor_main_cat" 	class="nav-link" on:click={e=>handleListCat(e)} 	on:keypress={handleListCat}>☰ Frm</button></li>
